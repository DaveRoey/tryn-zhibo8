package com.tryndamere.zhibo8.redis.repostory.impl;
 ...
 * @Description
 */
public class RedisManagerImpl implements RedisManager<String, Object> {
    ...
    @Override
    public Set<Object> getSetUnion(String key, Set<String> set) {
    ...
    @Override
    public Set<Object> getSetIntersect(String key, Set<String> set) {
